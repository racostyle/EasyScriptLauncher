...
- If any errors occur during the loading or execution of scripts, they are logged, and the application will exit with an error code.

## Technical Details

- **Language**: C#
- **Framework**: .NET
- **PowerShell Integration**: The application uses the `Process` class to invoke PowerShell scripts with specified arguments.
- **Logging**: Simple file-based logging keeps track of the application's operations and any errors encountered.
...
This README provides an overview of how to use your `EasyScriptLauncher` application, covering the basic usage, configuration, and technical workings. It is structured to be accessible to both non-technical users and developers.
